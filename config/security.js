...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
    allRoutes: true,
    allowOrigins: ['https://bilagseksperten.smartmobilehouse.pl'],
    allowResponseHeaders:'Content-Range, X-Total-Count',
    allowRequestHeaders:'Content-Type, Authorization,Content-Range, X-Total-Count',
    allowRequestMethods:'GET, POST, PUT, DELETE, OPTIONS, HEAD',
    additionalExposedHeaders:'Content-Range, X-Total-Count'
  },
